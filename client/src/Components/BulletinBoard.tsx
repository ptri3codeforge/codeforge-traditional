...
const BulletinBoard = () => {
    ...
    const handleBoardClick = (e:any) => {
            e.preventDefault();
            e.target.className = 'flex bg-yellow-default text-white-default cursor-pointer shadow-lg w-full'
...
<div className="flex bg-white-default cursor-pointer shadow-lg w-full hover:bg-yellow-default" onClick={() => handleBoardClick}>
   <div className="flex mx-auto items-start px-2 py-2  hover:text-white-default">
