...
<div className="min-h-screen flex flex-row bg-gray-100">
  <div className="flex flex-col w-56  rounded-r-3xl overflow-hidden">
    ...
    <ul className="flex flex-col py-4">
      ...
      <li>
        <a href="#" onClick={() => setView('post')} className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-darkBlue-default hover:text-yellow-default">
          <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
              <BiMessageRounded/>
              </span>
